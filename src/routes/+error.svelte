<main class="bl_page404">
	...
	<p>
		Sorry! The page you are looking for can not be found. Perhaps the page you requested was moved
		or deleted. It is also possible that you made a small typo when entering the address. Go to the
		main page.
	</p>
	<div class="bl_page404__wrapper">
		...
		<a class="bl_page404__link" href="/home">go home</a>
	</div>
</main>
...
<style>
	...
	.bl_page404__link {
		...
		box-shadow:
			0 5px 0 #9c1007,
			inset 0 0 18px rgba(253, 60, 0, 0.75);
