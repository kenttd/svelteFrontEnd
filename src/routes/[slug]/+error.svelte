...
<div class="flex space-x-4 text-sm justify-evenly h-screen">
	<div class="justify-end">
		...
		<div class="my-4 hover:text-white hover:bg-[#0891b2] text-center p-3 px-5 rounded">
			Bookmark
		</div>
	...
	<div class="space-y-1">
		<div class="flex items-center space-x-4">
			<Skeleton class="h-20 w-20 rounded-full mt-4" />
			<div class="space-y-2">
				user not found
				<Skeleton class="h-4 w-[250px] my-4" />
				<Skeleton class="h-4 w-[200px] my-4" />
			</div>
		</div>
	</div>
	<Separator orientation="vertical" />
